...
export async function loadCommand(client: DreeperClient, path: string): Promise<void> {
...
export async function loadEvent(client: DreeperClient, path: string): Promise<void> {
